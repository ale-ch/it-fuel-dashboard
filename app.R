  ...
  navbarPage(
    ...
    tabPanel("Map", 
             ...
             absolutePanel(
               ...
               draggable = TRUE, top = 220, left = 40, right = "auto", 
    ...
    tabPanel("Analysis",
             ...
             sidebarLayout(
               sidebarPanel(
                 ...
                 h4("Scatterplot, Correlation Matrix, Density plots"),
...
server <- function(input, output, session) {
  ...
  metadata_reactive <- reactive(dataset_description)
  ...
  output$metadata_table <- renderDataTable(datatable(dataset_description,
                                                     filter = "top"))
